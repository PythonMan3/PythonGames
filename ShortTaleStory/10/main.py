...
class Character:
    def __init__(self, filename, dir_, pos, move_type):
...
def main():
    ...
    king = Character(os.path.join("data", "pipo-charachip011b.png"), DIR_DOWN, (12, 94), TYPE_STOP)
    soldier = Character(os.path.join("data", "pipo-charachip018.png"), DIR_DOWN, (13, 94), TYPE_MOVE)
    fieldMap.add_chara(king)
    fieldMap.add_chara(soldier)
